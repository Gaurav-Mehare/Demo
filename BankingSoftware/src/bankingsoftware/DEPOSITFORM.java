...
public class DEPOSITFORM extends javax.swing.JFrame {
     ...
     */
    Connection conn;
    public DEPOSITFORM() throws SQLException, ClassNotFoundException {
        Class.forName("com.mysql.cj.jdbc.Driver");
         conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/banking", "root", "root");

            System.out.println("Connection established");
        initComponents();
        jLabel5.setText(""+Customer.getAadharno());
        jLabel6.setText(Customer.getCustomer_Name());
        jLabel7.setText(""+Customer.getBalance());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            double new_amount =  Customer.getBalance() + amount;
            Customer.setBalance(new_amount);
            Statement st;
            
            st = conn.createStatement();
            String sql = "UPDATE customertable SET BALANCE="+new_amount+" WHERE ACC_NO="+Customer.getAadharno();
          int a =  st.executeUpdate(sql);
          if(a>=1){
              JOptionPane.showMessageDialog(rootPane, "Amount added");
              jLabel7.setText(""+new_amount);
              jTextField1.setText("");
